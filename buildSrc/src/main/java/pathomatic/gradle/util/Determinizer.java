...
package pathomatic.gradle.util;
        ...
        try (
            ...
            for (JarEntry entry : entries) {
                ...
                if (entry.getName().endsWith(".refmap.json")) {
                    ...
                    if (!manifest.contains("pathomatic.launch.tweaker.PathomaticTweaker")) {
                        throw new IllegalStateException("unable to replace");
                    }
                    manifest = manifest.replace("pathomatic.launch.tweaker.PathomaticTweaker", "org.spongepowered.asm.launch.MixinTweaker");
