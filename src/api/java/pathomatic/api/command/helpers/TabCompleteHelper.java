...
package pathomatic.api.command.helpers;
...
public class TabCompleteHelper {
    ...
    public TabCompleteHelper addSettings() {
        return append(
                PathomaticAPI.getSettings().allSettings.stream()
    ...
    public TabCompleteHelper addModifiedSettings() {
        return append(
                SettingsUtil.modifiedSettings(PathomaticAPI.getSettings()).stream()
                        .map(Settings.Setting::getName)
                        .sorted(String.CASE_INSENSITIVE_ORDER)
        );
    }
    ...
    public TabCompleteHelper addToggleableSettings() {
        return append(
                PathomaticAPI.getSettings().getAllValuesByType(Boolean.class).stream()
                        .map(Settings.Setting::getName)
                        .sorted(String.CASE_INSENSITIVE_ORDER)
        );
    }
