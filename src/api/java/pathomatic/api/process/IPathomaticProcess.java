...
import pathomatic.api.event.events.PathEvent;

/**
 * A process that can control the PathingBehavior.
 * <p>
 * Differences between a pathomatic process and a behavior:
 * <ul>
 * <li>Only one pathomatic process can be active at a time</li>
 ...
 *
 */
public interface IPathomaticProcess {
    ...
    /**
     * Called when this process is in control of pathing; Returns what Pathomatic should do.
     *
