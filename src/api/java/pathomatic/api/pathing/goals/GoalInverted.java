 ...
 * current goal. This goal just reverses the heuristic to act as a TRUE invert. Inverting a Y level? Pathomatic tries to
 * get away from that Y level. Inverting a GoalBlock? Pathomatic will try to make distance whether it's in the X, Y or Z
