...
import pathomatic.api.command.datatypes.EntityClassById;
import pathomatic.api.command.datatypes.IDatatypeFor;
import pathomatic.api.command.datatypes.NearbyPlayer;
import pathomatic.api.command.exception.CommandErrorMessageException;
...
public class FollowCommand extends Command {
    ...
    public FollowCommand(IPathomatic pathomatic) {
        super(pathomatic, "follow");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        if (args.hasExactlyOne()) {
            pathomatic.getFollowProcess().follow((group = args.getEnum(FollowGroup.class)).filter);
        } else {
            args.requireMin(2);
            group = null;
            ...
            pathomatic.getFollowProcess().follow(
                    classes.isEmpty()
                            ? entities::contains
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The follow command tells Pathomatic to follow certain kinds of entities.",
                "",
                "Usage:",
