...
import pathomatic.api.command.datatypes.BlockById;
...
public class FindCommand extends Command {
    ...
    public FindCommand(IPathomatic pathomatic) {
        super(pathomatic, "find");
    }
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The find command searches through Pathomatic's cache and attempts to find the location of the block.",
