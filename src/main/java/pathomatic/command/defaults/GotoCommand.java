...
public class GotoCommand extends Command {
    ...
    protected GotoCommand(IPathomatic pathomatic) {
        super(pathomatic, "go");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        pathomatic.getGetToBlockProcess().getToBlock(destination);
    }
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The go command tells Pathomatic to head towards a given goal or block.",
                "",
                "Wherever a coordinate is expected, you can use ~ just like in regular Minecraft commands. Or, you can just use regular numbers.",
                "",
                "Usage:",
                "> go <block> - Go to a block, wherever it is in the world",
                "> go <y> - Go to a Y level",
                "> go <x> <z> - Go to an X,Z position",
                "> go <x> <y> <z> - Go to an X,Y,Z position"
        );
    }
}
