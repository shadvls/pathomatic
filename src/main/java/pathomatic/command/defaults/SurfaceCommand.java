...
public class SurfaceCommand extends Command {
    ...
    protected SurfaceCommand(IPathomatic pathomatic) {
        super(pathomatic, "surface", "top");
    }
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The surface/top command tells Pathomatic to head towards the closest surface-like area.",
                "",
