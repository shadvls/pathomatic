...
public class ReloadAllCommand extends Command {
    ...
    public ReloadAllCommand(IPathomatic pathomatic) {
        super(pathomatic, "reloadall");
    }
    ...
    public String getShortDesc() {
        return "Reloads Pathomatic's cache for this world";
    }

    @Override
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The reloadall command reloads Pathomatic's world cache.",
                "",
                "Usage:",
                "> reloadall"
        );
