...
import pathomatic.api.pathing.goals.GoalAxis;
...
public class AxisCommand extends Command {
    ...
    public AxisCommand(IPathomatic pathomatic) {
        super(pathomatic, "axis", "highway");
    }
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The axis command sets a goal that tells Pathomatic to head towards the nearest axis. That is, X=0 or Z=0.",
                "",
                "Usage:",
                "> axis"
        );
