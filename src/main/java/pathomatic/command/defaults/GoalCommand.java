...
import pathomatic.api.command.datatypes.RelativeCoordinate;
import pathomatic.api.command.datatypes.RelativeGoal;
...
public class GoalCommand extends Command {
    ...
    public GoalCommand(IPathomatic pathomatic) {
        super(pathomatic, "goal");
    }

    @Override
    public void execute(String label, IArgConsumer args) throws CommandException {
        ICustomGoalProcess goalProcess = pathomatic.getCustomGoalProcess();
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The goal command allows you to set or clear Pathomatic's goal.",
                "",
