...
public class ExploreFilterCommand extends Command {
    ...
    public ExploreFilterCommand(IPathomatic pathomatic) {
        super(pathomatic, "explorefilter");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        try {
            pathomatic.getExploreProcess().applyJsonFilter(file.toPath().toAbsolutePath(), invert);
