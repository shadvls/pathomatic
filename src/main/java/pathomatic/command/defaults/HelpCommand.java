...
public class HelpCommand extends Command {
    ...
    public HelpCommand(IPathomatic pathomatic) {
        super(pathomatic, "help", "?");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        if (!args.hasAny() || args.is(Integer.class)) {
            Paginator.paginate(
                    args, new Paginator<>(
                            this.pathomatic.getCommandManager().getRegistry().descendingStream()
                                    .filter(command -> !command.hiddenFromHelp())
                                    .collect(Collectors.toList())
                    ),
                    () -> logDirect("All Pathomatic commands (clickable):"),
                    command -> {
            ...
            ICommand command = this.pathomatic.getCommandManager().getCommand(commandName);
            if (command == null) {
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "Using this command, you can view detailed help information on how to use certain commands of Pathomatic.",
                "",
                "Usage:",
