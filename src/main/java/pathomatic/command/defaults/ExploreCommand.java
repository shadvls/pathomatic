...
import pathomatic.api.command.datatypes.RelativeGoalXZ;
...
public class ExploreCommand extends Command {
    ...
    public ExploreCommand(IPathomatic pathomatic) {
        super(pathomatic, "explore");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        pathomatic.getExploreProcess().explore(goal.getX(), goal.getZ());
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "Tell Pathomatic to explore randomly. If you used explorefilter before this, it will be applied.",
                "",
                "Usage:",
