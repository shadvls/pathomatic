...
public class RepackCommand extends Command {
    ...
    public RepackCommand(IPathomatic pathomatic) {
        super(pathomatic, "repack", "rescan");
    }

    @Override
    public void execute(String label, IArgConsumer args) throws CommandException {
        args.requireMax(0);
        logDirect(String.format("Queued %d chunks for repacking", PathomaticAPI.getProvider().getWorldScanner().repack(ctx)));
    }
