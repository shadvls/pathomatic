...
import pathomatic.api.command.exception.CommandNotEnoughArgumentsException;
import pathomatic.api.command.exception.CommandNotFoundException;
...
import pathomatic.behavior.Behavior;
import pathomatic.command.argument.ArgConsumer;
import pathomatic.command.argument.CommandArguments;
...
public class ExamplePathomaticControl extends Behavior implements Helper {

    private static final Settings settings = PathomaticAPI.getSettings();
    private final ICommandManager manager;

    public ExamplePathomaticControl(Pathomatic pathomatic) {
        super(pathomatic);
        this.manager = pathomatic.getCommandManager();
    }
    ...
    public void onPreTabComplete(TabCompleteEvent event) {
        ...
        if (args.size() == 1 && !commandPrefix.contains(" ")) {
