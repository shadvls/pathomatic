...
package pathomatic.command.argument;
...
import pathomatic.api.command.datatypes.IDatatype;
import pathomatic.api.command.datatypes.IDatatypeContext;
import pathomatic.api.command.datatypes.IDatatypeFor;
import pathomatic.api.command.datatypes.IDatatypePost;
...
import pathomatic.api.command.exception.CommandTooManyArgumentsException;
...
public class ArgConsumer implements IArgConsumer {
    ...
    public <T, O, D extends IDatatypePost<T, O>> T getDatatypePost(D datatype, O original) throws CommandInvalidTypeException, CommandNotEnoughArgumentsException {
        try {
            ...
            if (Pathomatic.settings().verboseCommandExceptions.value) {
                e.printStackTrace();
            }
    ...
    private final class Context implements IDatatypeContext {
        ...
        public final IPathomatic getPathomatic() {
            return ArgConsumer.this.manager.getPathomatic();
        }
