...
package pathomatic.command.manager;
...
import pathomatic.api.command.exception.CommandUnhandledException;
import pathomatic.api.command.exception.ICommandException;
...
import pathomatic.command.defaults.DefaultCommands;
...
public class CommandManager implements ICommandManager {
    ...
    public CommandManager(Pathomatic pathomatic) {
        this.pathomatic = pathomatic;
        DefaultCommands.createAll(pathomatic).forEach(this.registry::register);
    }

    @Override
    public IPathomatic getPathomatic() {
        return this.pathomatic;
    }
    ...
    public Stream<String> tabComplete(String prefix) {
        ...
        if (args.isEmpty()) {
            return new TabCompleteHelper()
                    .addCommands(this.pathomatic.getCommandManager())
                    .filterPrefix(label)
                    .stream();
        } else {
