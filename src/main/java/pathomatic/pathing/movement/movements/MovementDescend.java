...
public class MovementDescend extends Movement {
    ...
    public MovementDescend(IPathomatic pathomatic, BetterBlockPos start, BetterBlockPos end) {
        super(pathomatic, start, end, new BetterBlockPos[]{end.above(2), end.above(), end}, end.below());
    }
    ...
    public MovementState updateState(MovementState state) {
        ...
        state.setInput(Input.SNEAK, Pathomatic.settings().allowWalkOnMagmaBlocks.value && ctx.world().getBlockState(ctx.player().blockPosition().below()).is(Blocks.MAGMA_BLOCK));
