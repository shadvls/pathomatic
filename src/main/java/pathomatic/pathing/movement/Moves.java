...
import pathomatic.utils.pathing.MutableMoveResult;
...
public enum Moves {
    DOWNWARD(0, -1, 0) {
        ...
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            return new MovementDownward(context.getPathomatic(), src, src.below());
        }
    ...
    PILLAR(0, +1, 0) {
        @Override
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            return new MovementPillar(context.getPathomatic(), src, src.above());
        }
    ...
    TRAVERSE_NORTH(0, 0, -1) {
        @Override
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            return new MovementTraverse(context.getPathomatic(), src, src.north());
        }
    ...
    TRAVERSE_SOUTH(0, 0, +1) {
        @Override
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            return new MovementTraverse(context.getPathomatic(), src, src.south());
        }
    ...
    TRAVERSE_EAST(+1, 0, 0) {
        @Override
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            return new MovementTraverse(context.getPathomatic(), src, src.east());
        }
    ...
    TRAVERSE_WEST(-1, 0, 0) {
        @Override
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            return new MovementTraverse(context.getPathomatic(), src, src.west());
        }
    ...
    ASCEND_NORTH(0, +1, -1) {
        @Override
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            return new MovementAscend(context.getPathomatic(), src, new BetterBlockPos(src.x, src.y + 1, src.z - 1));
        }
    ...
    ASCEND_EAST(+1, +1, 0) {
        @Override
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            return new MovementAscend(context.getPathomatic(), src, new BetterBlockPos(src.x + 1, src.y + 1, src.z));
        }
    ...
    DESCEND_EAST(+1, -1, 0, false, true) {
        ...
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            ...
            if (res.y == src.y - 1) {
                return new MovementDescend(context.getPathomatic(), src, new BetterBlockPos(res.x, res.y, res.z));
            } else {
                return new MovementFall(context.getPathomatic(), src, new BetterBlockPos(res.x, res.y, res.z));
            }
        }
    ...
    DIAGONAL_NORTHEAST(+1, 0, -1, false, true) {
        ...
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            MutableMoveResult res = new MutableMoveResult();
            apply(context, src.x, src.y, src.z, res);
            return new MovementDiagonal(context.getPathomatic(), src, Direction.NORTH, Direction.EAST, res.y - src.y);
        }
    ...
    DIAGONAL_NORTHWEST(-1, 0, -1, false, true) {
        ...
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            MutableMoveResult res = new MutableMoveResult();
            apply(context, src.x, src.y, src.z, res);
            return new MovementDiagonal(context.getPathomatic(), src, Direction.NORTH, Direction.WEST, res.y - src.y);
        }
    ...
    DIAGONAL_SOUTHEAST(+1, 0, +1, false, true) {
        ...
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            MutableMoveResult res = new MutableMoveResult();
            apply(context, src.x, src.y, src.z, res);
            return new MovementDiagonal(context.getPathomatic(), src, Direction.SOUTH, Direction.EAST, res.y - src.y);
        }
    ...
    DIAGONAL_SOUTHWEST(-1, 0, +1, false, true) {
        ...
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            MutableMoveResult res = new MutableMoveResult();
            apply(context, src.x, src.y, src.z, res);
            return new MovementDiagonal(context.getPathomatic(), src, Direction.SOUTH, Direction.WEST, res.y - src.y);
        }
