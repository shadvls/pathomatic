...
import pathomatic.api.pathing.calc.IPathFinder;
...
public abstract class AbstractNodeCostSearch implements IPathFinder, Helper {
    ...
    /**
     * @see <a href="https://github.com/shadvls/pathomatic/issues/107">Issue #107</a>
     */
    ...
    AbstractNodeCostSearch(BetterBlockPos realStart, int startX, int startY, int startZ, Goal goal, CalculationContext context) {
        ...
        this.map = new Long2ObjectOpenHashMap<>(Pathomatic.settings().pathingMapDefaultSize.value, Pathomatic.settings().pathingMapLoadFactor.value);
    }
