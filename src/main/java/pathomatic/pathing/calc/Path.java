...
import pathomatic.pathing.path.CutoffPath;
import pathomatic.utils.pathing.PathBase;
...
class Path extends PathBase {
    ...
    Path(BetterBlockPos realStart, PathNode start, PathNode end, int numNodes, Goal goal, CalculationContext context) {
        ...
        // See PathingBehavior#createPathfinder and https://github.com/shadvls/pathomatic/pull/4519
