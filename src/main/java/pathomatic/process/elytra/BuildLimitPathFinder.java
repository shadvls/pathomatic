...
public class BuildLimitPathFinder implements IElytraPathFinder {
    ...
    public CompletableFuture<UnpackedSegment> pathFindAsync(BlockPos src, BlockPos dst) {
        ...
        final double maxDistance = Pathomatic.settings().elytraLongDistanceThreshold.value >= 32 ? (double) Pathomatic.settings().elytraLongDistanceThreshold.value : Double.POSITIVE_INFINITY;
