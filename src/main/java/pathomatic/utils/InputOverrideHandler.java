...
public final class InputOverrideHandler extends Behavior implements IInputOverrideHandler {
    ...
    public InputOverrideHandler(Pathomatic pathomatic) {
        super(pathomatic);
        this.blockBreakHelper = new BlockBreakHelper(pathomatic.getPlayerContext());
        this.blockPlaceHelper = new BlockPlaceHelper(pathomatic.getPlayerContext());
    }
    ...
    private boolean inControl() {
        ...
        return pathomatic.getPathingBehavior().isPathing() || pathomatic != PathomaticAPI.getProvider().getPrimaryPathomatic();
    }
