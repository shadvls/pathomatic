...
public final class PathRenderer implements IRenderer {
    ...
    public static void render(RenderEvent event, PathingBehavior behavior) {
        ...
        final DimensionType currentRenderViewDimension = PathomaticAPI.getProvider().getPrimaryPathomatic().getPlayerContext().world().dimensionType();
    ...
    public static void drawManySelectionBoxes(PoseStack stack, Entity player, Collection<BlockPos> positions, Color color) {
        ...
        BlockStateInterface bsi = new BlockStateInterface(PathomaticAPI.getProvider().getPrimaryPathomatic().getPlayerContext()); // TODO this assumes same dimension between primary pathomatic and render view? is this safe?
